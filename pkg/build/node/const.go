...
var defaultCNIImages = []string{"calico/cni:v3.7.2", "calico/node:v3.7.2", "calico/kube-controllers:v3.7.2"}

// https://docs.projectcalico.org/v3.7/manifests/calico.yaml but templated

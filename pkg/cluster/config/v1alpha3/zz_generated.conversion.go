...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Network)(nil), (*config.Network)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_Network_To_config_Network(a.(*Network), b.(*config.Network), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.Network)(nil), (*Network)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_Network_To_v1alpha3_Network(a.(*config.Network), b.(*Network), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_Cluster_To_config_Cluster(in *Cluster, out *config.Cluster, s conversion.Scope) error {
	...
	if err := Convert_v1alpha3_Network_To_config_Network(&in.Network, &out.Network, s); err != nil {
		return err
	}
...
func autoConvert_config_Cluster_To_v1alpha3_Cluster(in *config.Cluster, out *Cluster, s conversion.Scope) error {
	...
	if err := Convert_config_Network_To_v1alpha3_Network(&in.Network, &out.Network, s); err != nil {
		return err
	}
	out.KubeadmConfigPatches = *(*[]string)(unsafe.Pointer(&in.KubeadmConfigPatches))
	out.KubeadmConfigPatchesJSON6902 = *(*[]kustomize.PatchJSON6902)(unsafe.Pointer(&in.KubeadmConfigPatchesJSON6902))
...
func autoConvert_v1alpha3_Network_To_config_Network(in *Network, out *config.Network, s conversion.Scope) error {
	out.APIServerPort = in.APIServerPort
	out.APIServerListenAddress = in.APIServerListenAddress
	return nil
}

// Convert_v1alpha3_Network_To_config_Network is an autogenerated conversion function.
func Convert_v1alpha3_Network_To_config_Network(in *Network, out *config.Network, s conversion.Scope) error {
	return autoConvert_v1alpha3_Network_To_config_Network(in, out, s)
}

func autoConvert_config_Network_To_v1alpha3_Network(in *config.Network, out *Network, s conversion.Scope) error {
	out.APIServerPort = in.APIServerPort
	out.APIServerListenAddress = in.APIServerListenAddress
	return nil
}

// Convert_config_Network_To_v1alpha3_Network is an autogenerated conversion function.
func Convert_config_Network_To_v1alpha3_Network(in *config.Network, out *Network, s conversion.Scope) error {
	return autoConvert_config_Network_To_v1alpha3_Network(in, out, s)
}

...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*KubeadmConfiguration)(nil), (*config.KubeadmConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_KubeadmConfiguration_To_config_KubeadmConfiguration(a.(*KubeadmConfiguration), b.(*config.KubeadmConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.KubeadmConfiguration)(nil), (*KubeadmConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_KubeadmConfiguration_To_v1alpha2_KubeadmConfiguration(a.(*config.KubeadmConfiguration), b.(*KubeadmConfiguration), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_Config_To_config_Config(in *Config, out *config.Config, s conversion.Scope) error {
	...
	if err := Convert_v1alpha2_KubeadmConfiguration_To_config_KubeadmConfiguration(&in.Kubeadm, &out.Kubeadm, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_config_Config_To_v1alpha2_Config(in *config.Config, out *Config, s conversion.Scope) error {
	...
	if err := Convert_config_KubeadmConfiguration_To_v1alpha2_KubeadmConfiguration(&in.Kubeadm, &out.Kubeadm, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha2_KubeadmConfiguration_To_config_KubeadmConfiguration(in *KubeadmConfiguration, out *config.KubeadmConfiguration, s conversion.Scope) error {
	out.InitCommand = in.InitCommand
	out.JoinCommand = in.JoinCommand
	return nil
}

// Convert_v1alpha2_KubeadmConfiguration_To_config_KubeadmConfiguration is an autogenerated conversion function.
func Convert_v1alpha2_KubeadmConfiguration_To_config_KubeadmConfiguration(in *KubeadmConfiguration, out *config.KubeadmConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha2_KubeadmConfiguration_To_config_KubeadmConfiguration(in, out, s)
}

func autoConvert_config_KubeadmConfiguration_To_v1alpha2_KubeadmConfiguration(in *config.KubeadmConfiguration, out *KubeadmConfiguration, s conversion.Scope) error {
	out.InitCommand = in.InitCommand
	out.JoinCommand = in.JoinCommand
	return nil
}

// Convert_config_KubeadmConfiguration_To_v1alpha2_KubeadmConfiguration is an autogenerated conversion function.
func Convert_config_KubeadmConfiguration_To_v1alpha2_KubeadmConfiguration(in *config.KubeadmConfiguration, out *KubeadmConfiguration, s conversion.Scope) error {
	return autoConvert_config_KubeadmConfiguration_To_v1alpha2_KubeadmConfiguration(in, out, s)
}

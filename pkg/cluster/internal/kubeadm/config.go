...
// ConfigTemplateAutoDiscoveryBetaV2 is the kubadm config template for API version v1beta2
// using the address autodiscovery mechanisms of kubernetes in the following components:
// kube-apiserver kubernetes/kubernetes#84727
// kubelet kubernetes/kubernetes#85850
const ConfigTemplateAutoDiscoveryBetaV2 = `# config generated by kind
apiVersion: kubeadm.k8s.io/v1beta2
kind: ClusterConfiguration
metadata:
  name: config
...
func Config(data ConfigData) (config string, err error) {
	...
	templateSource := ConfigTemplateAutoDiscoveryBetaV2

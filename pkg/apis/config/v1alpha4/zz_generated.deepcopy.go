...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DockerIP) DeepCopyInto(out *DockerIP) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DockerIP.
func (in *DockerIP) DeepCopy() *DockerIP {
	if in == nil {
		return nil
	}
	out := new(DockerIP)

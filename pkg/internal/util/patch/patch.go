...
// Package patch contains helpers for patching yaml
package patch
...
// Patch takes a yaml document stream to patch, merge patches, and JSON 6902 patches
// It returns a patched a yaml document stream.
//
// Matching is performed on Kubernetes style v1 TypeMeta fields (kind and apiVersion),
// between the yaml documents and the patches.
//
...
func Patch(toPatch string, patches []string, patches6902 []config.PatchJSON6902) (string, error) {

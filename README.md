...
Pre-Request Installations: [Go] and [Docker] <br>
  ```go
...
Designed for testing Kubernetes 1.11+ [conformance tests].<br>

`kind` <br>
bootstraps each "node" with [kubeadm][kubeadm] and consists of:
...
<!-- I think is redundent now the top

...
If you have [go] and [docker], [podman] or [nerdctl] installed `go install sigs.k8s.io/kind@v0.33.0 && kind create cluster` is all you need!
...
You can install kind with `go install sigs.k8s.io/kind@v0.33.0`.
...
```console
# For Intel Macs
[ $(uname -m) = x86_64 ] && curl -Lo ./kind https://kind.sigs.k8s.io/dl/v0.33.0/kind-darwin-amd64
# For M1 / ARM Macs
[ $(uname -m) = arm64 ] && curl -Lo ./kind https://kind.sigs.k8s.io/dl/v0.33.0/kind-darwin-arm64
chmod +x ./kind
